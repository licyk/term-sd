...
python_package_manager()
{
    ...
    python_package_name=$(dialog --erase-on-exit --title "Term-SD" --backtitle ""$term_sd_manager_info" pip软件包安装/重装/卸载选项" --ok-label "确认" --cancel-label "取消" --inputbox "请输入需要安装/重装/卸载的pip软件包名" $term_sd_dialog_width $term_sd_dialog_height 3>&1 1>&2 2>&3)
