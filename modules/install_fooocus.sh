...
function process_install_fooocus()
{
    ...
    if [ $final_install_check_exec = 0 ];then
        ...
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/stabilityai/stable-diffusion-xl-refiner-1.0/resolve/main/sd_xl_refiner_1.0_0.9vae.safetensors -d ./Fooocus/models/checkpoints/ -o sd_xl_refiner_1.0_0.9vae.safetensors
        ...
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/lllyasviel/fooocus_inpaint/resolve/main/inpaint.fooocus.patch -d ./Fooocus/models/inpaint/ -o inpaint.fooocus.patch
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/lllyasviel/fooocus_inpaint/resolve/main/fooocus_inpaint_head.pth -d ./Fooocus/models/inpaint/ -o fooocus_inpaint_head.pth
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/lllyasviel/misc/resolve/main/fooocus_expansion.bin -d ./Fooocus/models/prompt_expansion/fooocus_expansion/ -o pytorch_model.bin
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/lllyasviel/misc/resolve/main/fooocus_upscaler_s409985e5.bin -d ./Fooocus/models/upscale_models/ -o fooocus_upscaler_s409985e5.bin
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/lllyasviel/misc/resolve/main/vaeapp_sd15.pt -d ./Fooocus/models/vae_approx -o vaeapp_sd15.pth
        cmd_daemon aria2c $aria2_multi_threaded https://huggingface.co/lllyasviel/misc/resolve/main/xl-to-v1_interposer-v3.1.safetensors -d ./Fooocus/models/vae_approx -o xl-to-v1_interposer-v3.1.safetensors
