...
function process_install_fooocus()
{
    ...
    if [ $final_install_check_exec = 0 ];then
        ...
        cmd_daemon git clone ${github_proxy}github.com/lllyasviel/Fooocus
        ...
        cmd_daemon git clone ${github_proxy}github.com/comfyanonymous/ComfyUI ./Fooocus/repositories/ComfyUI-from-StabilityAI-Official
        cd ./Fooocus
        create_venv
        enter_venv
        cd ..
