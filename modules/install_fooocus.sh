    ...
    cat<<EOF
{
    ...
    "CLIP Skip": "CLIP 跳过层数",
    "Bypass CLIP layers to avoid overfitting (use 1 to not skip any layers, 2 is recommended).": "CLI跳过层数可避免过拟合的情况（使用 1 为不跳过任何层，2 为推荐值）",
    "VAE": "VAE 模型",
    "Default (model)": "默认",
