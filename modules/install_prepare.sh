...
pytorch_version_select() {
    ...
    dialog_arg=$(dialog --erase-on-exit --notags \
        ...
        $(get_dialog_size_menu) \
        "141" "> Torch 2.10.0 (CUDA 12.6) + xFormers 0.0.34" \
        "140" "> Torch 2.10.0 (CUDA 12.8) + xFormers 0.0.34" \
        "139" "> Torch 2.10.0 (CUDA 13.0) + xFormers 0.0.34" \
        "138" "> Torch 2.10.0 (Intel XPU)" \
        "137" "> Torch 2.10.0 (ROCm 7.1) + xFormers 0.0.34" \
        "136" "> Torch 2.10.0 (CPU)" \
        "135" "> Torch 2.10.0" \
        "134" "> Torch 2.9.1 (CUDA 12.6) + xFormers 0.0.33.post2" \
        "133" "> Torch 2.9.1 (CUDA 12.8) + xFormers 0.0.33.post2" \
        "132" "> Torch 2.9.1 (CUDA 13.0) + xFormers 0.0.33.post2" \
        "131" "> Torch 2.9.1 (Intel XPU)" \
        "130" "> Torch 2.9.1 (ROCm 6.3)" \
        "129" "> Torch 2.9.1 (ROCm 6.4) + xFormers 0.0.33.post2" \
        "128" "> Torch 2.9.1 (CPU)" \
        "127" "> Torch 2.9.1" \
        "126" "> Torch 2.9.0 (CUDA 12.6) + xFormers 0.0.33" \
        "125" "> Torch 2.9.0 (CUDA 12.8) + xFormers 0.0.33" \
        "124" "> Torch 2.9.0 (CUDA 13.0) + xFormers 0.0.33" \
        "123" "> Torch 2.9.0 (Intel XPU)" \
        "122" "> Torch 2.9.0 (ROCm 6.3)" \
        "121" "> Torch 2.9.0 (ROCm 6.4) + xFormers 0.0.33" \
        "120" "> Torch 2.9.0 (CPU)" \
        "119" "> Torch 2.9.0" \
    ...
    case "${dialog_arg}" in
        ...
        118)
            ...
            ;;
        119)
            INSTALL_PYTORCH_VERSION="torch==2.9.0 torchvision==0.24.0 torchaudio==2.9.0"
            ;;
        120)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+cpu torchvision==0.24.0+cpu torchaudio==2.9.0+cpu"
            PYTORCH_TYPE="cpu"
            ;;
        121)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+rocm6.4 torchvision==0.24.0+rocm6.4 torchaudio==2.9.0+rocm6.4"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33"
            PYTORCH_TYPE="rocm64"
            ;;
        122)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+rocm6.3 torchvision==0.24.0+rocm6.3 torchaudio==2.9.0+rocm6.3"
            PYTORCH_TYPE="rocm63"
            ;;
        123)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+xpu torchvision==0.24.0+xpu torchaudio==2.9.0+xpu"
            PYTORCH_TYPE="xpu"
            ;;
        124)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+cu130 torchvision==0.24.0+cu130 torchaudio==2.9.0+cu130"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33"
            PYTORCH_TYPE="cu130"
            ;;
        125)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+cu128 torchvision==0.24.0+cu128 torchaudio==2.9.0+cu128"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33"
            PYTORCH_TYPE="cu128"
            ;;
        126)
            INSTALL_PYTORCH_VERSION="torch==2.9.0+cu126 torchvision==0.24.0+cu126 torchaudio==2.9.0+cu126"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33"
            PYTORCH_TYPE="cu126"
            ;;
        127)
            INSTALL_PYTORCH_VERSION="torch==2.9.1 torchvision==0.24.1 torchaudio==2.9.1"
            ;;
        128)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+cpu torchvision==0.24.1+cpu torchaudio==2.9.1+cpu"
            PYTORCH_TYPE="cpu"
            ;;
        129)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+rocm6.4 torchvision==0.24.1+rocm6.4 torchaudio==2.9.1+rocm6.4"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33.post2"
            PYTORCH_TYPE="rocm64"
            ;;
        130)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+rocm6.3 torchvision==0.24.1+rocm6.3 torchaudio==2.9.1+rocm6.3"
            PYTORCH_TYPE="rocm63"
            ;;
        131)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+xpu torchvision==0.24.1+xpu torchaudio==2.9.1+xpu"
            PYTORCH_TYPE="xpu"
            ;;
        132)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+cu130 torchvision==0.24.1+cu130 torchaudio==2.9.1+cu130"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33.post2"
            PYTORCH_TYPE="cu130"
            ;;
        133)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+cu128 torchvision==0.24.1+cu128 torchaudio==2.9.1+cu128"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33.post2"
            PYTORCH_TYPE="cu128"
            ;;
        134)
            INSTALL_PYTORCH_VERSION="torch==2.9.1+cu126 torchvision==0.24.1+cu126 torchaudio==2.9.1+cu126"
            INSTALL_XFORMERS_VERSION="xformers==0.0.33.post2"
            PYTORCH_TYPE="cu126"
            ;;
        135)
            INSTALL_PYTORCH_VERSION="torch==2.10.0 torchvision==0.25.0 torchaudio==2.10.0"
            ;;
        136)
            INSTALL_PYTORCH_VERSION="torch==2.10.0+cpu torchvision==0.25.0+cpu torchaudio==2.10.0+cpu"
            PYTORCH_TYPE="cpu"
            ;;
        137)
            INSTALL_PYTORCH_VERSION="torch==2.10.0+rocm7.1 torchvision==0.25.0+rocm7.1 torchaudio==2.10.0+rocm7.1"
            INSTALL_XFORMERS_VERSION="xformers==0.0.34"
            PYTORCH_TYPE="rocm71"
            ;;
        138)
            INSTALL_PYTORCH_VERSION="torch==2.10.0+xpu torchvision==0.25.0+xpu torchaudio==2.10.0+xpu"
            PYTORCH_TYPE="xpu"
            ;;
        139)
            INSTALL_PYTORCH_VERSION="torch==2.10.0+cu130 torchvision==0.25.0+cu130 torchaudio==2.10.0+cu130"
            INSTALL_XFORMERS_VERSION="xformers==0.0.34"
            PYTORCH_TYPE="cu130"
            ;;
        140)
            INSTALL_PYTORCH_VERSION="torch==2.10.0+cu128 torchvision==0.25.0+cu128 torchaudio==2.10.0+cu128"
            INSTALL_XFORMERS_VERSION="xformers==0.0.34"
            PYTORCH_TYPE="cu128"
            ;;
        141)
            INSTALL_PYTORCH_VERSION="torch==2.10.0+cu126 torchvision==0.25.0+cu126 torchaudio==2.10.0+cu126"
            INSTALL_XFORMERS_VERSION="xformers==0.0.34"
            PYTORCH_TYPE="cu126"
            ;;
    esac
