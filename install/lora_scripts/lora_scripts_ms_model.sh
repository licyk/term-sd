...
__term_sd_task_pre_model_62 get_modelscope_model licyks/sd-model/master/sdxl_1.0/ChenkinNoob-XL-V0.1.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # ChenkinNoob-XL-V0.1(6.94g) OFF
__term_sd_task_pre_model_63 get_modelscope_model licyks/sd-model/master/sdxl_1.0/ChenkinNoob-XL-V0.2.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # ChenkinNoob-XL-V0.2(6.94g) OFF
__term_sd_task_pre_model_64 get_modelscope_model licyks/sd-model/master/sdxl_1.0/PVCStyleModelMovable_nbxl12.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # PVCStyleModelMovable_nbxl12(6.94g) OFF
__term_sd_task_pre_model_65 get_modelscope_model licyks/sd-model/master/sdxl_1.0/PVCStyleModelMovable_nbxlVPredV10.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # PVCStyleModelMovable_nbxlVPredV10(6.94g) OFF
__term_sd_task_pre_model_66 get_modelscope_model licyks/sd-model/master/sdxl_1.0/ponyDiffusionV6XL_v6StartWithThisOne.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # ponyDiffusionV6XL_v6(6.94g) OFF
__term_sd_task_pre_model_67 get_modelscope_model licyks/sd-model/master/sdxl_1.0/pdForAnime_v20.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # pdForAnime_v20(7.11g) OFF
__term_sd_task_pre_model_68 get_modelscope_model licyks/sd-model/master/sdxl_1.0/tPonynai3_v51WeightOptimized.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # tPonynai3_v51WeightOptimized(6.94g) OFF
__term_sd_task_pre_model_69 get_modelscope_model licyks/sd-model/master/sdxl_1.0/omegaPonyXLAnime_v20.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # omegaPonyXLAnime_v20(6.94g) OFF
__term_sd_task_pre_model_70 get_modelscope_model licyks/sd-model/master/sdxl_1.0/animeIllustDiffusion_v061.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # animeIllustDiffusion_v061(6.94g) OFF
__term_sd_task_pre_model_71 get_modelscope_model licyks/sd-model/master/sdxl_1.0/artiwaifuDiffusion_v10.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # artiwaifuDiffusion_v10(6.94g) OFF
__term_sd_task_pre_model_72 get_modelscope_model licyks/sd-model/master/sdxl_1.0/artiwaifu-diffusion-v2.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # artiwaifu-diffusion-v2(6.94g) OFF
__term_sd_task_pre_model_73 # =====VAE模型===== OFF
__term_sd_task_pre_model_74 get_modelscope_model licyks/sd-vae/master/sd_1.5/vae-ft-ema-560000-ema-pruned.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # vae-ft-ema-560000-ema-pruned(334.6m) OFF
__term_sd_task_pre_model_75 get_modelscope_model licyks/sd-vae/master/sd_1.5/vae-ft-mse-840000-ema-pruned.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # vae-ft-mse-840000-ema-pruned(334.6m) OFF
__term_sd_task_pre_model_76 get_modelscope_model licyks/sd-vae/master/sdxl_1.0/sdxl_fp16_fix_vae.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # sdxl_fp16_fix_vae(334.6m) OFF
__term_sd_task_pre_model_77 get_modelscope_model licyks/sd-vae/master/sdxl_1.0/sdxl_vae.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # sdxl_vae(334.6m) OFF
__term_sd_task_pre_model_78 # =====FLUX模型===== OFF
__term_sd_task_pre_model_79 get_modelscope_model licyks/flux-model/master/flux_1/flux1-dev.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # flux1-dev(23.8g) OFF
__term_sd_task_pre_model_80 get_modelscope_model licyks/flux-model/master/flux_1/flux1-schnell.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # flux1-schnell(23.8g) OFF
__term_sd_task_pre_model_81 get_modelscope_model licyks/flux-model/master/flux_1/ashen0209-flux1-dev2pro.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # ashen0209-flux1-dev2pro(23.8g) OFF
__term_sd_task_pre_model_82 get_modelscope_model licyks/flux-model/master/flux_1/jimmycarter-LibreFLUX.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # jimmycarter-LibreFLUX(23.8g) OFF
__term_sd_task_pre_model_83 get_modelscope_model licyks/flux-model/master/flux_1/nyanko7-flux-dev-de-distill.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # nyanko7-flux-dev-de-distill(23.8g) OFF
__term_sd_task_pre_model_84 get_modelscope_model licyks/flux-model/master/flux_1/shuttle-3-diffusion.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # shuttle-3-diffusion(23.8g) OFF
__term_sd_task_pre_model_85 # =====FLUX-文本编码器/VAE模型===== OFF
__term_sd_task_pre_model_86 get_modelscope_model licyks/flux-model/master/flux_text_encoders/clip_l.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # clip_l(246.1m) OFF
__term_sd_task_pre_model_87 get_modelscope_model licyks/flux-model/master/flux_text_encoders/t5xxl_fp16.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # t5xxl_fp16(9.79g) OFF
__term_sd_task_pre_model_88 get_modelscope_model licyks/flux-model/master/flux_vae/ae.safetensors "${LORA_SCRIPTS_ROOT_PATH}"/sd-models/ # ae(335m) OFF
