...
__term_sd_task_pre_core install_python_package -r "${LORA_SCRIPTS_PATH}"/sd-scripts/requirements.txt # sd-scripts 目录下还有个 _typos.toml, 在安装 requirements.txt  里的依赖时会指向这个文件
