...
__term_sd_task_pre_core git_clone_repository ${github_mirror} https://github.com/kohya-ss/sd-scripts "$lora_scripts_folder" sd-scripts # lora-scripts后端
__term_sd_task_pre_core git_clone_repository ${github_mirror} https://github.com/hanamizuki-ai/lora-gui-dist "$lora_scripts_folder" frontend # lora-scripts前端
__term_sd_task_pre_core git_clone_repository ${github_mirror} https://github.com/Akegarasu/dataset-tag-editor "$lora_scripts_folder"/mikazuki dataset-tag-editor # 标签编辑器
