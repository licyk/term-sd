...
__term_sd_task_pre_model aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sd_1.5/animefull-final-pruned.safetensors "$lora_scripts_folder"/sd-models/ animefull-final-pruned.safetensors
