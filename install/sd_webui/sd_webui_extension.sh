...
__term_sd_task_pre_ext_8 git_clone_repository ${github_mirror} https://github.com/hako-mikan/sd-webui-supermerger stable-diffusion-webui/extensions ON # 模型融合扩展
...
__term_sd_task_pre_ext_15 git_clone_repository ${github_mirror} https://github.com/CodeZombie/latentcoupleregionmapper stable-diffusion-webui/extensions OFF # 控制绘制和定义区域
...
__term_sd_task_pre_ext_18 git_clone_repository ${github_mirror} https://github.com/AlUlkesh/stable-diffusion-webui-images-browser stable-diffusion-webui/extensions OFF # 图像管理器
...
__term_sd_task_pre_ext_22 git_clone_repository ${github_mirror} https://github.com/fkunn1326/openpose-editor stable-diffusion-webui/extensions OFF # openpose姿势编辑
...
__term_sd_task_pre_ext_27 git_clone_repository ${github_mirror} https://github.com/catppuccin/stable-diffusion-webui stable-diffusion-webui/extensions ON # WEBUI主题
...
__term_sd_task_pre_ext_30 git_clone_repository ${github_mirror} https://github.com/ashen-sensored/stable-diffusion-webui-two-shot stable-diffusion-webui/extensions OFF # 图片区域分割和控制
...
__term_sd_task_pre_ext_37 git_clone_repository ${github_mirror} https://github.com/continue-revolution/sd-webui-animatediff stable-diffusion-webui/extensions OFF # 视频生成扩展
__term_sd_task_pre_ext_38 git_clone_repository ${github_mirror} https://github.com/yankooliveira/sd-webui-photopea-embed stable-diffusion-webui/extensions OFF # 在WEBUI界面添加ps功能
...
__term_sd_task_pre_ext_40 git_clone_repository ${github_mirror} https://github.com/hnmr293/sd-webui-llul stable-diffusion-webui/extensions OFF # 给图片的选定区域增加细节
...
__term_sd_task_pre_ext_66 git_clone_repository ${github_mirror} https://github.com/Uminosachi/sd-webui-inpaint-anything stable-diffusion-webui/extensions OFF # 使用seg生成的蒙版进行图像重绘
__term_sd_task_pre_ext_67 git_clone_repository ${github_mirror} https://github.com/thomasasfk/sd-webui-aspect-ratio-helper stable-diffusion-webui/extensions OFF # 图片尺寸比例固定
...
__term_sd_task_pre_ext_69 git_clone_repository ${github_mirror} https://github.com/hako-mikan/sd-webui-negpip stable-diffusion-webui/extensions ON # 解决tag的强污染，效果比cutoff更强
