...
__term_sd_task_pre_ext_20 git_clone_repository https://github.com/Akegarasu/sd-webui-wd14-tagger "${SD_WEBUI_ROOT_PATH}"/extensions ON # 图片tag反推
...
__term_sd_task_pre_ext_86 git_clone_repository https://github.com/KohakuBlueleaf/a1111-sd-webui-haku-img "${SD_WEBUI_ROOT_PATH}"/extensions ON # 图像处理工具
...
__term_sd_task_pre_ext_175 git_clone_repository https://github.com/DenOfEquity/forgeFlux_dualPrompt "${SD_WEBUI_ROOT_PATH}"/extensions OFF # 为sd_webui_forge添加多提示词支持
__term_sd_task_pre_ext_176 git_clone_repository https://github.com/spawner1145/sd-webui-framepack "${SD_WEBUI_ROOT_PATH}"/extensions OFF # 添加FramePack支持
