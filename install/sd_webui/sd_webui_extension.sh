...
__term_sd_task_pre_ext_89 git_clone_repository https://github.com/w-e-w/sdwebui-close-confirmation-dialogue "${SD_WEBUI_ROOT_PATH}"/extensions ON # 添加关闭SD-WebUI界面的确认提醒
...
__term_sd_task_pre_ext_163 git_clone_repository https://github.com/viyiviyi/stable-diffusion-webui-zoomimage "${SD_WEBUI_ROOT_PATH}"/extensions ON # 为图片查看窗口添加鼠标缩放拖动功能
