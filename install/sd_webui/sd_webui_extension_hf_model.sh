...
__term_sd_task_pre_ext_10 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/z-tipo-extension/TIPO-500M_epoch5-F16.gguf "${SD_WEBUI_PATH}"/models/kgen
__term_sd_task_pre_ext_10 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/z-tipo-extension/TIPO-200M-40Btok-F16.gguf "${SD_WEBUI_PATH}"/models/kgen
