...
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11f1p_sd15_depth_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_canny_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_inpaint_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_lineart_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_mlsd_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_normalbae_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_openpose_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_scribble_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_seg_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15_softedge_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1/resolve/main/control_v11p_sd15s2_lineart_anime_fp16.safetensors "${SD_WEBUI_PATH}"/models/ControlNet
...
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/lama/ControlNetLama.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/lama
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/leres/latest_net_G.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/leres
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/leres/res101.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/leres
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/lineart/sk_model.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/lineart
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/lineart/sk_model2.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/lineart
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/lineart_anime/netG.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/lineart_anime
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/manga_line/erika.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/manga_line
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/midas/dpt_hybrid-midas-501f0c75.pt "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/midas
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/mlsd/mlsd_large_512_fp32.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/mlsd
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/normal_bae/scannet.pt "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/normal_bae
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/oneformer/150_16_swin_l_oneformer_coco_100ep.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/oneformer
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/oneformer/250_16_swin_l_oneformer_ade20k_160k.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/oneformer
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/openpose/body_pose_model.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/openpose
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/openpose/dw-ll_ucoco_384.onnx "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/openpose
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/openpose/facenet.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/openpose
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/openpose/hand_pose_model.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/openpose
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/openpose/yolox_l.onnx "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/openpose
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/pidinet/table5_pidinet.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/pidinet
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/uniformer/upernet_global_small.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/uniformer
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/zoedepth/ZoeD_M12_N.pt "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/zoedepth
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/anime_face_segment/UNet.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/anime_face_segment
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/densepose/densepose_r50_fpn_dl.torchscript "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/densepose
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/depth_anything/depth_anything_vitl14.pth "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/depth_anything
...
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/controlnet_v1.1_annotator/resolve/main/mobile_sam/mobile_sam.pt "${SD_WEBUI_PATH}"/extensions/sd-webui-controlnet/annotator/downloads/mobile_sam
...
__term_sd_task_pre_ext_3 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/adetailer/face_yolov8s.pt "${SD_WEBUI_PATH}"/models/adetailer
__term_sd_task_pre_ext_3 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/adetailer/hand_yolov8n.pt "${SD_WEBUI_PATH}"/models/adetailer
__term_sd_task_pre_ext_3 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/adetailer/hand_yolov8s.pt "${SD_WEBUI_PATH}"/models/adetailer
__term_sd_task_pre_ext_3 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/adetailer/person_yolov8m-seg.pt "${SD_WEBUI_PATH}"/models/adetailer
...
__term_sd_task_pre_ext_7 aria2_download https://huggingface.co/licyk/layerdiffusion/resolve/main/layer_xl_fgble2bg.safetensors "${SD_WEBUI_PATH}"/models/layer_model
__term_sd_task_pre_ext_7 aria2_download https://huggingface.co/licyk/layerdiffusion/resolve/main/layer_xl_transparent_attn.safetensors "${SD_WEBUI_PATH}"/models/layer_model
__term_sd_task_pre_ext_7 aria2_download https://huggingface.co/licyk/layerdiffusion/resolve/main/layer_xl_transparent_conv.safetensors "${SD_WEBUI_PATH}"/models/layer_model
...
__term_sd_task_pre_ext_10 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/z-tipo-extension/TIPO-500M_epoch5-F16.gguf "${SD_WEBUI_PATH}"/extensions/z-tipo-extension/models
__term_sd_task_pre_ext_10 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/z-tipo-extension/TIPO-200M-40Btok-F16.gguf "${SD_WEBUI_PATH}"/extensions/z-tipo-extension/models
__term_sd_task_pre_ext_10 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/z-tipo-extension/TIPO-200M-ft-F16.gguf "${SD_WEBUI_PATH}"/extensions/z-tipo-extension/models
