...
__term_sd_task_pre_model aria2_download https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned-emaonly.safetensors ./ComfyUI/models/checkpoints v1-5-pruned-emaonly.safetensors
