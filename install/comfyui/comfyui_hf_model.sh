...
__term_sd_task_pre_model_59 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/sd3_medium.safetensors "${COMFYUI_PATH}"/models/checkpoints # sd3_medium(4.34g) OFF
__term_sd_task_pre_model_60 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/sd3_medium_incl_clips.safetensors "${COMFYUI_PATH}"/models/checkpoints # sd3_medium_incl_clips(5.97g) OFF
__term_sd_task_pre_model_61 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/sd3_medium_incl_clips_t5xxlfp8.safetensors "${COMFYUI_PATH}"/models/checkpoints # sd3_medium_incl_clips_t5xxlfp8(10.87g) OFF
__term_sd_task_pre_model_62 # =====SD3文本编码器===== OFF
__term_sd_task_pre_model_63 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/text_encoders/clip_g.safetensors "${COMFYUI_PATH}"/models/clip # clip_g(1.39g) OFF
__term_sd_task_pre_model_64 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/text_encoders/clip_l.safetensors "${COMFYUI_PATH}"/models/clip # clip_l(246.1m) OFF
__term_sd_task_pre_model_65 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/text_encoders/t5xxl_fp16.safetensors "${COMFYUI_PATH}"/models/clip # t5xxl_fp16(9.79g) OFF
__term_sd_task_pre_model_66 aria2_download https://huggingface.co/licyk/sd-3-model/resolve/main/text_encoders/t5xxl_fp8_e4m3fn.safetensors "${COMFYUI_PATH}"/models/clip # t5xxl_fp8_e4m3fn(4.89g) OFF
