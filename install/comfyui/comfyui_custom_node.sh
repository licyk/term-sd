...
__term_sd_task_pre_ext_8 git_clone_repository ${github_mirror} https://github.com/ltdrdata/ComfyUI-Manager ComfyUI/custom_nodes ON # 自定义节点管理器
...
__term_sd_task_pre_ext_34 git_clone_repository ${github_mirror} https://github.com/ssitu/ComfyUI_UltimateSDUpscale ComfyUI/custom_nodes ON # 图片放大
...
__term_sd_task_pre_ext_37 git_clone_repository ${github_mirror} https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet ComfyUI/custom_nodes ON # 提示词翻译节点
...
__term_sd_task_pre_ext_40 git_clone_repository ${github_mirror} https://github.com/Stability-AI/stability-ComfyUI-nodes ComfyUI/custom_nodes OFF # Stability-AI自定义节点支持
...
__term_sd_task_pre_ext_44 git_clone_repository ${github_mirror} https://github.com/Kosinkadink/ComfyUI-AnimateDiff-Evolved ComfyUI/custom_nodes OFF # 视频生成节点
__term_sd_task_pre_ext_45 git_clone_repository ${github_mirror} https://github.com/Acly/comfyui-tooling-nodes ComfyUI/custom_nodes OFF # 使用ComfyUI作为外部工具后端的节点
...
__term_sd_task_pre_ext_50 git_clone_repository ${github_mirror} https://github.com/twri/sdxl_prompt_styler ComfyUI/custom_nodes OFF # SDXL提示词风格预设节点
__term_sd_task_pre_ext_51 git_clone_repository ${github_mirror} https://github.com/11cafe/comfyui-workspace-manager ComfyUI/custom_nodes ON # 工作流管理器
