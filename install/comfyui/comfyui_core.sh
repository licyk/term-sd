...
__term_sd_task_sys cd ./"$comfyui_folder"
...
__term_sd_task_pre_core term_sd_watch term_sd_pip install -r ./"$comfyui_folder"/requirements.txt --prefer-binary $pip_index_mirror $pip_extra_index_mirror $pip_find_mirror $pip_break_system_package $pip_install_mode
