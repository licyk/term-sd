...
__term_sd_task_pre_core git_clone_repository ${github_mirror} https://github.com/comfyanonymous/ComfyUI Fooocus/repositories ComfyUI-from-StabilityAI-Official
