...
__term_sd_task_pre_core git_clone_repository ${github_mirror} https://github.com/comfyanonymous/ComfyUI Fooocus/repositories
__term_sd_task_pre_core mv -f ./Fooocus/repositories/ComfyUI Fooocus/repositories/ComfyUI-from-StabilityAI-Official
