...
__term_sd_task_pre_model_58 get_modelscope_model licyks/sd-model/master/sdxl_1.0/PVCStyleModelMovable_nbxl12.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # PVCStyleModelMovable_nbxl12(6.94g) OFF
__term_sd_task_pre_model_59 get_modelscope_model licyks/sd-model/master/sdxl_1.0/PVCStyleModelMovable_nbxlVPredV10.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # PVCStyleModelMovable_nbxlVPredV10(6.94g) OFF
__term_sd_task_pre_model_60 get_modelscope_model licyks/sd-model/master/sdxl_1.0/ponyDiffusionV6XL_v6StartWithThisOne.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # ponyDiffusionV6XL_v6(6.94g) OFF
__term_sd_task_pre_model_61 get_modelscope_model licyks/sd-model/master/sdxl_1.0/pdForAnime_v20.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # pdForAnime_v20(7.11g) OFF
__term_sd_task_pre_model_62 get_modelscope_model licyks/sd-model/master/sdxl_1.0/tPonynai3_v51WeightOptimized.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # tPonynai3_v51WeightOptimized(6.94g) OFF
__term_sd_task_pre_model_63 get_modelscope_model licyks/sd-model/master/sdxl_1.0/omegaPonyXLAnime_v20.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # omegaPonyXLAnime_v20(6.94g) OFF
__term_sd_task_pre_model_64 get_modelscope_model licyks/sd-model/master/sdxl_1.0/animeIllustDiffusion_v061.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # animeIllustDiffusion_v061(6.94g) OFF
__term_sd_task_pre_model_65 get_modelscope_model licyks/sd-model/master/sdxl_1.0/artiwaifuDiffusion_v10.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # artiwaifuDiffusion_v10(6.94g) OFF
__term_sd_task_pre_model_66 get_modelscope_model licyks/sd-model/master/sdxl_1.0/artiwaifu-diffusion-v2.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # artiwaifu-diffusion-v2(6.94g) OFF
__term_sd_task_pre_model_67 get_modelscope_model licyks/sd-model/master/sdxl_1.0/AnythingXL_xl.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # AnythingXL_xl(6.94g) OFF
__term_sd_task_pre_model_68 get_modelscope_model licyks/sd-model/master/sdxl_1.0/abyssorangeXLElse_v10.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # abyssorangeXLElse_v10(6.94g) OFF
__term_sd_task_pre_model_69 get_modelscope_model licyks/sd-model/master/sdxl_1.0/animaPencilXL_v200.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # animaPencilXL_v200(6.94g) OFF
__term_sd_task_pre_model_70 get_modelscope_model licyks/sd-model/master/sdxl_1.0/bluePencilXL_v401.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # bluePencilXL_v401(6.94g) OFF
__term_sd_task_pre_model_71 get_modelscope_model licyks/sd-model/master/sdxl_1.0/nekorayxl_v06W3.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # nekorayxl_v06W3(6.94g) OFF
__term_sd_task_pre_model_72 get_modelscope_model licyks/sd-model/master/sdxl_1.0/CounterfeitXL-V1.0.safetensors "${FOOOCUS_ROOT_PATH}"/models/checkpoints # CounterfeitXL-V1.0(6.94g) OFF
__term_sd_task_pre_model_73 # =====其他模型===== OFF
__term_sd_task_pre_model_74 get_modelscope_model licyks/sd-lora/master/sdxl/sd_xl_offset_example-lora_1.0.safetensors "${FOOOCUS_ROOT_PATH}"/models/loras # sd_xl_offset_example-lora_1.0(49.6m) ON
__term_sd_task_pre_model_75 get_modelscope_model licyks/fooocus-model/master/inpaint/inpaint.fooocus.patch "${FOOOCUS_ROOT_PATH}"/models/inpaint # inpaint.fooocus(1.32g) OFF
__term_sd_task_pre_model_76 get_modelscope_model licyks/fooocus-model/master/inpaint/inpaint_v26.fooocus.patch "${FOOOCUS_ROOT_PATH}"/models/inpaint # inpaint_v26.fooocus(1.32g) ON
__term_sd_task_pre_model_77 get_modelscope_model licyks/fooocus-model/master/inpaint/fooocus_inpaint_head.pth "${FOOOCUS_ROOT_PATH}"/models/inpaint # fooocus_inpaint_head(0.05m) ON
__term_sd_task_pre_model_78 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/pytorch_model.bin "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(351.2m) ON
__term_sd_task_pre_model_79 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/config.json "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(0.1m) ON
__term_sd_task_pre_model_80 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/merges.txt "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(0.1m) ON
__term_sd_task_pre_model_81 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/special_tokens_map.json "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(0.1m) ON
__term_sd_task_pre_model_82 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/tokenizer.json "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(2.1m) ON
__term_sd_task_pre_model_83 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/tokenizer_config.json "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(0.1m) ON
__term_sd_task_pre_model_84 get_modelscope_model licyks/fooocus-model/master/prompt_expansion/fooocus_expansion/vocab.json "${FOOOCUS_ROOT_PATH}"/models/prompt_expansion/fooocus_expansion # fooocus_expansion(0.1m) ON
__term_sd_task_pre_model_85 get_modelscope_model licyks/fooocus-model/master/upscale_models/fooocus_upscaler_s409985e5.bin "${FOOOCUS_ROOT_PATH}"/models/upscale_models # fooocus_upscaler_s409985e5(33.6m) ON
__term_sd_task_pre_model_86 get_modelscope_model licyks/fooocus-model/master/vae_approx/vaeapp_sd15.pth "${FOOOCUS_ROOT_PATH}"/models/vae_approx # vaeapp_sd15(0.2m) ON
__term_sd_task_pre_model_87 get_modelscope_model licyks/fooocus-model/master/vae_approx/xl-to-v1_interposer-v3.1.safetensors "${FOOOCUS_ROOT_PATH}"/models/vae_approx # xl-to-v1_interposer-v3.1(6.5m) OFF
__term_sd_task_pre_model_88 get_modelscope_model licyks/fooocus-model/master/vae_approx/xl-to-v1_interposer-v4.0.safetensors "${FOOOCUS_ROOT_PATH}"/models/vae_approx # xl-to-v1_interposer-v4.0(5.6m) ON
__term_sd_task_pre_model_89 get_modelscope_model licyks/fooocus-model/master/vae_approx/xlvaeapp.pth "${FOOOCUS_ROOT_PATH}"/models/vae_approx # xlvaeapp(0.2m) ON
__term_sd_task_pre_model_90 get_modelscope_model licyks/fooocus-model/master/loras/sdxl_lcm_lora.safetensors "${FOOOCUS_ROOT_PATH}"/models/loras # sdxl_lcm_lora(393.8m) ON
__term_sd_task_pre_model_91 get_modelscope_model licyks/fooocus-model/master/controlnet/control-lora-canny-rank128.safetensors "${FOOOCUS_ROOT_PATH}"/models/controlnet # control-lora-canny-rank128(395.7m) ON
__term_sd_task_pre_model_92 get_modelscope_model licyks/fooocus-model/master/controlnet/fooocus_ip_negative.safetensors "${FOOOCUS_ROOT_PATH}"/models/controlnet # fooocus_ip_negative(0.01m) ON
__term_sd_task_pre_model_93 get_modelscope_model licyks/fooocus-model/master/controlnet/fooocus_xl_cpds_128.safetensors "${FOOOCUS_ROOT_PATH}"/models/controlnet # fooocus_xl_cpds_128(395.7m) ON
__term_sd_task_pre_model_94 get_modelscope_model licyks/fooocus-model/master/controlnet/ip-adapter-plus_sdxl_vit-h.bin "${FOOOCUS_ROOT_PATH}"/models/controlnet # ip-adapter-plus_sdxl_vit-h(1.01g) ON
__term_sd_task_pre_model_95 get_modelscope_model licyks/fooocus-model/master/controlnet/detection_Resnet50_Final.pth "${FOOOCUS_ROOT_PATH}"/models/controlnet # detection_Resnet50_Final(103.5m) ON
__term_sd_task_pre_model_96 get_modelscope_model licyks/fooocus-model/master/controlnet/ip-adapter-plus-face_sdxl_vit-h.bin "${FOOOCUS_ROOT_PATH}"/models/controlnet # ip-adapter-plus-face_sdxl_vit-h(1.01g) ON
__term_sd_task_pre_model_97 get_modelscope_model licyks/fooocus-model/master/controlnet/parsing_parsenet.pth "${FOOOCUS_ROOT_PATH}"/models/controlnet # parsing_parsenet(85.3m) ON
