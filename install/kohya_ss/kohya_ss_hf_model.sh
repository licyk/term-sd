...
__term_sd_task_pre_model aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sd_1.5/animefull-final-pruned.ckpt ./kohya_ss/models/ animefull-final-pruned.ckpt
