...
__term_sd_task_pre_model_63 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/PVCStyleModelMovable_nbxl12.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # PVCStyleModelMovable_nbxl12(6.94g) OFF
__term_sd_task_pre_model_64 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/PVCStyleModelMovable_nbxlVPredV10.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # PVCStyleModelMovable_nbxlVPredV10(6.94g) OFF
__term_sd_task_pre_model_65 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/ponyDiffusionV6XL_v6StartWithThisOne.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # ponyDiffusionV6XL_v6(6.94g) OFF
__term_sd_task_pre_model_66 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/pdForAnime_v20.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # pdForAnime_v20(7.11g) OFF
__term_sd_task_pre_model_67 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/tPonynai3_v51WeightOptimized.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # tPonynai3_v51WeightOptimized(6.94g) OFF
__term_sd_task_pre_model_68 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/omegaPonyXLAnime_v20.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # omegaPonyXLAnime_v20(6.94g) OFF
__term_sd_task_pre_model_69 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/animeIllustDiffusion_v061.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # animeIllustDiffusion_v061(6.94g) OFF
__term_sd_task_pre_model_70 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/artiwaifuDiffusion_v10.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # artiwaifuDiffusion_v10(6.94g) OFF
__term_sd_task_pre_model_71 aria2_download https://huggingface.co/licyk/sd-model/resolve/main/sdxl_1.0/artiwaifu-diffusion-v2.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # artiwaifu-diffusion-v2(6.94g) OFF
__term_sd_task_pre_model_72 # =====VAE模型===== OFF
__term_sd_task_pre_model_73 aria2_download https://huggingface.co/licyk/sd-vae/resolve/main/sd_1.5/vae-ft-ema-560000-ema-pruned.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # vae-ft-ema-560000-ema-pruned(334.6m) OFF
__term_sd_task_pre_model_74 aria2_download https://huggingface.co/licyk/sd-vae/resolve/main/sd_1.5/vae-ft-mse-840000-ema-pruned.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # vae-ft-mse-840000-ema-pruned(334.6m) OFF
__term_sd_task_pre_model_75 aria2_download https://huggingface.co/licyk/sd-vae/resolve/main/sdxl_1.0/sdxl_fp16_fix_vae.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # sdxl_fp16_fix_vae(334.6m) OFF
__term_sd_task_pre_model_76 aria2_download https://huggingface.co/licyk/sd-vae/resolve/main/sdxl_1.0/sdxl_vae.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # sdxl_vae(334.6m) OFF
__term_sd_task_pre_model_77 # =====FLUX模型===== OFF
__term_sd_task_pre_model_78 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_1/flux1-dev.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # flux1-dev(23.8g) OFF
__term_sd_task_pre_model_79 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_1/flux1-schnell.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # flux1-schnell(23.8g) OFF
__term_sd_task_pre_model_80 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_1/ashen0209-flux1-dev2pro.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # ashen0209-flux1-dev2pro(23.8g) OFF
__term_sd_task_pre_model_81 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_1/jimmycarter-LibreFLUX.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # jimmycarter-LibreFLUX(23.8g) OFF
__term_sd_task_pre_model_82 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_1/nyanko7-flux-dev-de-distill.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # nyanko7-flux-dev-de-distill(23.8g) OFF
__term_sd_task_pre_model_83 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_1/shuttle-3-diffusion.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # shuttle-3-diffusion(23.8g) OFF
__term_sd_task_pre_model_84 # =====FLUX-文本编码器/VAE模型===== OFF
__term_sd_task_pre_model_85 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_text_encoders/clip_l.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # clip_l(246.1m) OFF
__term_sd_task_pre_model_86 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_text_encoders/t5xxl_fp16.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # t5xxl_fp16(9.79g) OFF
__term_sd_task_pre_model_87 aria2_download https://huggingface.co/licyk/flux-model/resolve/main/flux_vae/ae.safetensors "${KOHYA_SS_ROOT_PATH}"/models/ # ae(335m) OFF
