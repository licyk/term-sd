...
__term_sd_task_pre_ext_1 aria2_download https://huggingface.co/licyk/sd-extensions-model/resolve/main/z-tipo-extension/TIPO-200M-ft-F16.gguf "${INVOKEAI_PATH}"/invokeai/models/kgen
